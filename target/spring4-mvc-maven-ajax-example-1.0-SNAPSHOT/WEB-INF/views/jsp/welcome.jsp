	...
	<div class="starter-template">
		...
		<form class="form-horizontal" id="search-form">
			<div class="form-group form-group-lg">
				...
				<div class="col-sm-10">
					<input type=text class="form-control" id="username" value="mkyong">
				</div>
			</div>
			<div class="form-group form-group-lg">
				<label class="col-sm-2 control-label">Email</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="email" value="mkyong@yahoo.com">
				</div>
			</div>
			...
			<div class="form-group form-group-lg">
				...
				<div class="col-sm-10">
					<input type=text class="form-control" id="empid" value=>
				</div>
			</div>
			<div class="form-group form-group-lg">
			...
			<div class="form-group">
				...
				<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="button" id="bth-getdata"
						class="btn btn-primary btn-lg">get data</button>
				</div>
			</div>
		</form>
